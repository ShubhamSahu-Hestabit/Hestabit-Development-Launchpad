...
MODEL_NAME = "gpt2"  # lightweight public tokenizer
FINAL_SIZE = 1200
...
def compute_token_length(sample):
    text = (
...
lengths = [compute_token_length(x) for x in clean_data]
...
print(f"\nAfter removing samples > {MAX_TOKEN_LENGTH} tokens: {len(filtered_data)}")
